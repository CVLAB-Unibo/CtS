...
train_nuscenes = list(sorted(set(train_detect + train_track)))
...
def preprocess(nusc, split_names, root_dir, out_dir,
    ...
    for i, sample in enumerate(nusc.sample):
        ...
        curr_split = None
        for split_name in split_names:
            if curr_scene_name in getattr(sys.modules[__name__], split_name):
        ...
        pts_valid_flag, pts_cam_coord, pts_img, depth = map_pointcloud_to_image(pts, (900, 1600, 3), calib_infos)
...
if __name__ == '__main__':
    root_dir = '/media/data5/acardace/dataset/nuScenes_lidarseg/'
    out_dir = '/media/data5/acardace/dataset/nuScenes_lidarseg/preprocessed_nuscenes_lidarseg_ALL'
    ...
    preprocess(nusc, ['train_nuscenes'], root_dir, out_dir)
    preprocess(nusc, ['val_nuscenes'], root_dir, out_dir)
    # preprocess(nusc, ['test_nuscenes'], root_dir, out_dir)
